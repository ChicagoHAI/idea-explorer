...
class GitHubManager:
    ...
    def create_research_repo(self,
        ...
        description += f" | Generated by Idea Explorer on {datetime.now().strftime('%Y-%m-%d')}"
...
Output ONLY the repository name, nothing else."""
    ...
    def add_research_metadata(self,
        ...
        Creates:
        - .idea-explorer/idea.yaml with full idea spec
        ...
        print("✓ Added idea metadata to .idea-explorer/idea.yaml")
